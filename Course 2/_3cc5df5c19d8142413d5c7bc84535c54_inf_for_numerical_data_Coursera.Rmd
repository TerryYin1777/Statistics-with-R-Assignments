...
nc1 = nc %>% select(weight, habit) %>% filter(habit != "NA")
ggplot(nc1,aes(x = habit,y = weight))+
  geom_boxplot()
```
...
inference(x = habit, y = weight, data = nc, type = "ci",statistic = "mean", method = "theoretical",order = c("smoker","nonsmoker"))
```
...
```{r gained-mature-ht}
# type your code for the Exercise here, and Knit
inference(x = mature, y = gained, data = nc, type = "ht", statistic = "mean", null = 0, alternative = "twosided", method = "theoretical")
```
...
```{r pick-your-own}
# type your code for the Exercise here, and Knit
inference(x = marital, y = mage, data=nc, statistic = "mean", type = "ht",null = 0,alternative = "twosided", method = "theoretical")
ggplot(nc,aes(x = marital, y = mage))+
  geom_boxplot()
```
